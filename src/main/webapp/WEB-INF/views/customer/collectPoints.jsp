        ...
        <div class="col-md-4 offset-md-4">
            <div class="card">
                <div class="card-body px-5" style="background-color:#bd4e44">
                    <h3 class="text-center my-3">Points Collection</h3>
                    <h5 class="text-center my-3" style="background-color:#189e06">${msg}</h5>
                    <form action="doCollect" method="post">
                        <div class="form-group">
                            <label for="points">Points</label>
                            <input name="points" step="1" type="number" class="form-control"
                                   id="points" placeholder="Enter the points" value="0" required>
                        </div>
